...
class injectorFileGenerator{
    injectionFileBasePath   = "generators/injectFiles/"
    generatedFileName       = "injectionFile"
    oldVersionsDir          = this.serviceRepoBasePath+"oldVersions"
    injectionSample         = {}

    constructor(){
        this.serviceRepoSample = {}
        this.serviceRepoBasePath = "generators/injectFiles/"
    }
...
module.exports = injectorFileGenerator
